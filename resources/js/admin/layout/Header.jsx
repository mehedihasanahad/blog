            ...
            >
              <button type="button" id="dropdownToggle" onClick={() => setProfileDropDown(!profileDropDown)}
                className="px-4 py-2 flex items-center rounded-full text-[#333] text-sm border border-gray-300 outline-none hover:bg-gray-100">
                {
                  ...
                  <img src={'/' + userInfo?.profile_image} className="w-7 h-7 mr-3 rounded-full shrink-0"></img> :
              ...
              {
                profileDropDown && 
                <ul id="dropdownMenu" className='absolute shadow-lg bg-white py-2 z-[1000] min-w-full w-max rounded-lg max-h-96 overflow-auto'>
